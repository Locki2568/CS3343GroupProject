...
public class Main 
{
	...
	public static void importMenu(String fileName) throws FileNotFoundException
	{
	...
	public static void reset()
	{
		...
		tmpFoodCombination = new ArrayList<ArrayList<Food>>();
		tmpFoodCombinationList = new ArrayList<Combination>();
	}
}
